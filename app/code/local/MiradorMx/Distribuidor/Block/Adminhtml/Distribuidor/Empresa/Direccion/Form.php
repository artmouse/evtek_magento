 ...
 */
class MiradorMx_Distribuidor_Block_Adminhtml_Distribuidor_Empresa_Direccion_Form extends Mage_Adminhtml_Block_Widget_Form {
	...
	function _prepareForm() {
		...
		$fieldset = $form->addFieldset('form_form', array('legend' => Mage::helper('distribuidor')->__('Información de dirección')));
		...
		$id = Mage::app()->getRequest()->getParam('id_empresa');
		$model = Mage::getModel('distribuidor/distribuidor')->load($id);
